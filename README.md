...
2. Выполните команду `yarn` и `init` - только в режиме разработки
...
`docker compose build` - если вносите какие-то изменения, перед поднятием докера не забывайте сбилдить образ с вашими изменениями
