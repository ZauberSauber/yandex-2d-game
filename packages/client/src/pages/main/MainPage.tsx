import { Button, Card, Col, Divider, Flex, Layout, List, Row, Space, Typography } from 'antd';
    ...
    <Layout className={styles.layout}>
      <Header className={styles.header}>
        <Flex
          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }} />
            <Button ghost size="large" className={styles['start-button']}>
              НАЧАТЬ ИГРУ
            </Button>
          </Space>
        </Flex>
      ...
      <Content className={styles.content}>
        ...
        <Row justify="center" className={styles['action-row']}>
          <Col>
            <Button ghost size="large" className={styles['immerse-button']}>
              НАЧАТЬ ПОГРУЖЕНИЕ
            </Button>
          </Col>
        </Row>
